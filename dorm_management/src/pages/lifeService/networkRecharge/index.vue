<template>
  <BreadCrumb :firstTitle="'生活服务'" :secondTitle="'校园网充值'"></BreadCrumb>
  <el-card>
    <h1>校园网查询</h1>
    ...
    <el-form>
      ...
      <el-row>
        <el-col :span="6">
          <el-radio v-model="money" :label="20" border size="large">一月20元</el-radio>
        </el-col>
        <el-col :span="6">
          <el-radio v-model="money" :label="40" border size="large">两月40元</el-radio>
        </el-col>
        <el-col :span="6">
          <el-radio v-model="money" :label="110" border size="large">半年110</el-radio>
        </el-col>
        <el-col :span="6">
          <el-radio v-model="money" :label="220" border size="large">一年220元</el-radio>
        </el-col>
      </el-row>
